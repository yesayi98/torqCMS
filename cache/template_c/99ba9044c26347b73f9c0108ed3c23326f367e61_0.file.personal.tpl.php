<?php
/* Smarty version 3.1.34-dev-7, created on 2020-05-27 18:53:26
  from 'C:\Users\User\OSPanel\domains\torq\public\frontend\account\personal.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5ece8cf6eb5d96_96532593',
...
function content_5ece8cf6eb5d96_96532593 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="login">
    <div class="login_form_container">
        <div class="account_login_form">
             <div class="row">
                ...
                <div class="col-lg-6 col-md-6 form-box-change">
                    <label>Էլ․ փոստ<span>*</span></label>
                    <input type="email">
                </div>
                <div class="col-lg-6 col-md-6 form-box-change">
                    <label>Հեռախոս<span>*</span></label>
                    <input type="number">
                </div>

                <div class="col-lg-12 col-md-12 form-box-change">
                    <label>Հասցե<span>*</span></label>
                    <input type="password">
                </div>

                <div class="col-lg-6 col-md-6 form-box-change">
                    <label>Գաղտնաբառ<span>*</span></label>
                    <input type="password">
                </div>

                <div class="col-lg-6 col-md-6 form-box-change">
                    <label>Կրկնել գաղտնաբառը<span>*</span></label>
                    <input type="password">
                </div>
