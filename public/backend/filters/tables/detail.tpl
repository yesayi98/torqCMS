{extends file="backend/filters/tables/index.tpl"}
  ...
  <div class="card">
      <div class="card-header text-uppercase">
        ...
        <div class="cart-buttons float-right button-group">
          ...
          {if $currency}
          <button type="button" data-url="{url url='backend/filters/deletetype?l='|cat:$table.id}" class="btn btn-danger" name="delete-detail"><i class="fa fa-trash"></i> delete</button>
          {/if}
