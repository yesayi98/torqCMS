                           ...
                           <a href="javascript:void(0)"><span class="lnr lnr-cart"></span><span class="item_count">2</span></a>
                            ...
                            <div class="mini_cart">
                                <div class="cart_gallery">
                                    <div class="cart_item">
                                       <div class="cart_img">
                                           <a href="index.html#"><img src="{$BASE_FRONTEND}assets/img/s-product/product.jpg" alt=""></a>
                                       </div>
                                        <div class="cart_info">
                                    ...
                                    <div class="cart_item">
                                       <div class="cart_img">
                                           <a href="index.html#"><img src="{$BASE_FRONTEND}assets/img/s-product/product2.jpg" alt=""></a>
                                       </div>
                                        <div class="cart_info">
